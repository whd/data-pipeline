...
if [ ! -f "patches_applied" ]; then
    ...
    echo "Adding external plugin for landfill http output"
    echo "add_external_plugin(git https://github.com/whd/data-pipeline/landfill_http_output :local)" >> cmake/plugin_loader.cmake
fi
